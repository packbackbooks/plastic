...
use Packback\ElasticsearchDSL\Query\FullText\CommonTermsQuery;
use Packback\ElasticsearchDSL\Query\FullText\MatchQuery;
use Packback\ElasticsearchDSL\Query\FullText\MultiMatchQuery;
use Packback\ElasticsearchDSL\Query\FullText\QueryStringQuery;
use Packback\ElasticsearchDSL\Query\FullText\SimpleQueryStringQuery;
use Packback\ElasticsearchDSL\Query\Geo\GeoBoundingBoxQuery;
use Packback\ElasticsearchDSL\Query\Geo\GeoDistanceQuery;
use Packback\ElasticsearchDSL\Query\Geo\GeoDistanceRangeQuery;
use Packback\ElasticsearchDSL\Query\Geo\GeoPolygonQuery;
use Packback\ElasticsearchDSL\Query\Geo\GeoShapeQuery;
...
use Packback\ElasticsearchDSL\Query\TermLevel\FuzzyQuery;
use Packback\ElasticsearchDSL\Query\TermLevel\IdsQuery;
use Packback\ElasticsearchDSL\Query\TermLevel\PrefixQuery;
use Packback\ElasticsearchDSL\Query\TermLevel\RangeQuery;
use Packback\ElasticsearchDSL\Query\TermLevel\RegexpQuery;
use Packback\ElasticsearchDSL\Query\TermLevel\TermQuery;
use Packback\ElasticsearchDSL\Query\TermLevel\TermsQuery;
use Packback\ElasticsearchDSL\Query\TermLevel\WildcardQuery;
